...
@interface JCAnimatedPageControl()
...
@end
@implementation JCAnimatedPageControl
...
- (void)initialization
{
    self.dotViewClass           = [JCAnimatedDotView class];
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[JCAnimatedDotView class]] && self.dotColor) {
            ((JCAnimatedDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
...
{
    if (self.dotViewClass) {
        JCAbstractDotView *abstractDotView = (JCAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [JCAbstractDotView class]);
        }
